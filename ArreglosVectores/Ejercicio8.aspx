<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ejercicio8.aspx.cs" Inherits="ArreglosVectores.Ejercicio8" %>
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblMostrarElementos" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
